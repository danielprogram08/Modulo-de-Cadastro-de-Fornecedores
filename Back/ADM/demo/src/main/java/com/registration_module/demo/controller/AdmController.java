...
public class AdmController {
    ...
    public Optional<AdmProjection> SearchByCredentials (@PathVariable String name, @PathVariable String password) {
        Optional<AdmProjection> result = admService.SearchByCredentials(name, password);
        return result;
    }
